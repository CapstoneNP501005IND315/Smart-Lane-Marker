/*  HC12 smart lane marker psuedo car signal module 
    By Nung-Shun Chou and David Shen
...
/*========Timer counter variable declaration==========*/
int counter =0;
int datacounter;

/*========Data validation variable declaration======*/
...
/*Software Serial port cofiguration*/
...
void loop() 
{
  counter++;
    if (counter>=10000){           
    //comment bottom line for demo purpose
    //Serial.println("Seraching for tags.....");
    HC12.print("<CAR>");
    counter =0;
